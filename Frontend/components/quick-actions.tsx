      ...
      <CardContent className="p-6">
        ...
        {activeTab === "general" && (
          ...
          <div className="space-y-3">
            ...
            <Button variant="outline" className="w-full justify-start" onClick={onShareDashboard}>
        ...
        {activeTab === "data" && (
          ...
          <div className="space-y-3">
            ...
            <Button variant="outline" className="w-full justify-start" onClick={onGenerateReport}>
